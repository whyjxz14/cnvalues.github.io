questions = [
    ...
    {
        "question": "即使面临人口膨胀或人口老龄化的压力，生不生、生多少小孩也是每个人的自由，政府和社会不应当干涉（包括鼓励生育）。",
        "effect": {
            "govt": 5
        }
    },
    ...
    {
        "question": "相比于大一统，像欧洲那样依据地理、民族、语言和文化等标准分成数个小国家更好。",
        "effect": {
            "jieti": 10
        }
    },
    ...
    {
        "question": "个人自由主义和靠做题实现阶级上升破坏了小共同体，让人们陷入个人权利得不到保障的原子化个人的状态。",
        "effect": {
            "shequn": 10
        }
    }
